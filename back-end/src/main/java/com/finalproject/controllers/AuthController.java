...
import com.finalproject.service.TwoFactorVerification;
...
public class AuthController {
  ...
  @Autowired private TwoFactorVerification twoFactorVerification;
...
//    }
  ...
  public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
    ...
    if (signUpRequest.isMfa()) {
      ...
      signUpRequest.setSecret(twoFactorVerification.generateSecret());
    }
...
//    return ResponseEntity.ok(new MessageResponse("User registered successfully!"));
    ...
    return ResponseEntity.created(location)
            .body(new SignupResponse(user1.isMfa(), twoFactorVerification.getUriForImage(user.getSecret())));
  }
}
