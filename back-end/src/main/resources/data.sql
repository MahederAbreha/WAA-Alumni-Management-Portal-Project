...
VALUES(true, 'subo@gmail.com', 0, '$2a$10$u8WolM01.f6TXBWzgctoQ.33R72LEYFnsetQCmvmgD4g5QWRoeTqe', 'student', 'Maheder', 'Abreha', '2022-07-09 10:22:49.828');
INSERT INTO public.users(account_non_locked, email, failed_attempt,"password", username, first_name, last_name, logged_at)
VALUES(true, 'stu1@gmail.com', 0, '$2a$10$u8WolM01.f6TXBWzgctoQ.33R72LEYFnsetQCmvmgD4g5QWRoeTqe', 'student1', 'Eudis', 'Muhangi', '2022-07-10 19:26:49.828');
INSERT INTO public.users(account_non_locked, email, failed_attempt,"password", username, first_name, last_name, logged_at)
VALUES(true, 'stu2@gmail.com', 0, '$2a$10$u8WolM01.f6TXBWzgctoQ.33R72LEYFnsetQCmvmgD4g5QWRoeTqe', 'student2', 'Niqedimos', 'Weldemariam', '2022-07-07 12:25:49.828');
...
VALUES(4.0, 'CS', 615237, 1);
INSERT INTO public.student(gpa, major, student_id, user_id)
VALUES(3.89, 'CS', 614000, 2);
INSERT INTO public.student(gpa, major, student_id, user_id)
VALUES(4.0, 'MBA', 623000, 3);

INSERT INTO public."comments"("comment", commenter, student_id, post_time)
VALUES('He is Extraordinary ', 'faculty', 1, '2022-07-09 17:22:49.828');
INSERT INTO public."comments"("comment", commenter, student_id, post_time)
VALUES('He is good', 'faculty', 1, '2022-07-09 17:22:49.828');
INSERT INTO public."comments"("comment", commenter, student_id, post_time)
VALUES('He is another level ', 'admin', 1, '2022-07-09 17:22:49.828');


INSERT INTO public.address(city, state, street, zip, id_user)
VALUES('Fairfield', 'IA', '1000 4th st', '52557', 1);
INSERT INTO public.address(city, state, street, zip, id_user)
VALUES('Fairfield', 'IA', '1000 5th st', '52555', 2);
INSERT INTO public.address(city, state, street, zip, id_user)
VALUES('Fairfield', 'IA', '1000 7th st', '52554', 3);
INSERT INTO public.address(city, state, street, zip, id_user)
VALUES('Fairfield', 'IA', '1000 9th st', '52556', 4);
...
INSERT INTO public.job_advertisement(company, states, city, benefit, description, posted, salary, title)
VALUES('Facebook', 'CA','San Francisco','build your experience', 'Full stack developer, Web Experience at Indeed Senior Fullstack  Developers, Web Experience at Indeed serve a critical role in getting designs into production, bridging the design and engineering organizations. Senior UX Developers work with a cross-functional team to build accessible user interfaces for our products; create fast, scalable, maintainable, and secure systems; define best practices in UI development; and contribute to design ideation and decision making', '2022-07-09 17:22:49.828', 184000, 'Senior UX Developer, Web Experience');
