...
const SignupPage = (props) => {
    ...
    return (
        <div className="container mt-5" style={{ color: 'orange' }}>
            <div className="card ms-auto me-auto p-3 shadow-lg custom-card">
                <FontAwesomeIcon icon={faUserCircle} className="ms-auto me-auto user-icon" style={{ color: 'orange' }}/>
                ...
                <form
                    ...
                    <button className="btn btn-info w-100 mt-3" style={{ color: 'red',background : 'orange' }}
                        disabled={loading}>
                        Sign Up
                    </button>

                </form>
                <Link to="/login" className="btn btn-link" style={{ color: 'orange' }} >
                    I have an Account!
                </Link>
            </div>
        </div>
